...
# Click top-right of screen to open the quick-settings panel.
# The system indicators live in the rightmost ~200px of the 32px panel.
xdotool mousemove 1200 16 click 1
sleep 1.5
...
if [ -n "${BOUNDS}" ]; then
    ...
    # QS panel opens at right of screen; capture the brightness row area
    import -window root -crop 360x70+900+44 /docs/soft-brightness-plus.png
